...
# Función simple para mover archivos procesados
        ...
        if not pdf_files:
                ...
                for file in pdf_files:
                    ...
                    #  print("Claves en factura_data:", factura_data.keys())
                        ...
                        # Aquí puedes mover el archivo procesado si lo deseas
                        mover_factura_procesada(file)  # <-- Llama aquí la función para mover el archivo
