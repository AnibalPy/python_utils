...
def main(page: ft.Page):
    page.title = "Recuperador de contraseñas Wifi Aníbal Ruiz"
    ...
    def delete_temp_files(e):
        selected_wifi = wifi_dropdown.value
        if not selected_wifi:
            status_text.value = "Por favor seleccione una wifi"
    ...
    page.add(
        ft.Column(
            [
                ft.Icon(ft.Icons.DELETE, size=50),
                ft.Text("Recupera tu contraseña Wifi", size=18, weight=ft.FontWeight.BOLD),
               wifi_dropdown,
                delete_button,
                status_text,
                ft.Text("Tu contraseña wifi es:", size=18, weight=ft.FontWeight.BOLD),
